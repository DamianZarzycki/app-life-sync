...
- Add-note modal opens after clicking a button on category card (title, content)
...
and category cards to track my progress, and report list at the bottom of the page.
...
### US-019 – User Preferences selection

**Description:**  
As an authenticated user, I want to be able to set from the list of all categories 3 that I want LLM to focus on the most when creating the report. I also should be able to set preferences on report generetion if I want to have it being sent via email and if yes I want to be able to select on which day of week and what time I want to receive the email.

**Acceptance Criteria:**

- From list of categories [pets, friends, body, mind, passion, family] user is able to select 3
- User can select if he wants to receive reports weekly on specific day and time

---

### US-020 – Access to list of generated reports

**Description:**  
As a user, I want to have access to the list of generated reports.

**Acceptance Criteria:**

- On dashboard page I have list of reports with these details (index | status | created_at | channel)
